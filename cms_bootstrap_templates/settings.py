# Django settings for cms_bootstrap_templates project.
import os
...
SECRET_KEY = 'edy3n+3g@@c*f!#s)##aoad!7t*uaoul&na*%r-wpiy^1$x8%y'
...
ROOT_URLCONF = 'cms_bootstrap_templates.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'cms_bootstrap_templates.wsgi.application'
